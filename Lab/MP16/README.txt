MP16 (Olympians, on Arrays)
Topic: Array of Numbers

Objective: The students should be able to use the array to store multiple values of the same type. The students will be able to learn the concept on smallest and highest values found in an array and how to obtain them.
